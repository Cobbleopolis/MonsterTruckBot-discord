...
object MessageUtil {
    ...
    /**
      ...
      */
    def commandUsageError(userMention: String, message: String, name: String): String = formatMessage(userMention, s"$message Please use `!${CorePlugin.helpCommand.name} $name` to see how to use this command.")
